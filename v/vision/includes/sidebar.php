<aside class="glass-sidebar" id="sidebar">
  <nav class="sidebar-nav">
    ...
    <?php if (!function_exists('isLoggedIn') || !isLoggedIn()): ?>
      ...
      <li><a href="/agenda.php#:~:text=N%C3%A3o%20se%20preocupe-,%3A,-s%C3%B3%20usaremos%20para" class="<?php echo isActive('registro', $current_page); ?>">
    ...
    <?php elseif ($role === 'subscriber' || $role === 'trial_7d' || $role === 'trial_24h'): ?>
      ...
      <li><a href="/dash-t101/" class="<?php echo isActive('dash', $current_page, $current_uri); ?>">
          <i class="fa-solid fa-gauge"></i><span>Dash-T101</span>
      </a></li>
      <li><a href="/glossarios.php" class="<?php echo isActive('glossarios', $current_page); ?>">
          <i class="fa-solid fa-book"></i><span>Glossários</span>
      </a></li>
...
<style>
/* Reset básico para o link do sidebar */
.sidebar-nav a {
    display: flex;
    align-items: center;
    gap: 12px;
    ...
    color: inherit;
    /* Reserva espaço da borda para evitar deslocamento */
    border-left: 4px solid transparent; 
    /* Transição suave usando Bézier */
...
/* Ícones */
.sidebar-nav a i {
    width: 24px; /* Largura fixa para o ícone */
    text-align: center;
    flex-shrink: 0; /* Impede que o ícone seja esmagado */
    transition: color 0.3s ease, text-shadow 0.3s ease;
}

/* Títulos do Menu - A MÁGICA ESTÁ AQUI */
.sidebar-nav a span {
    white-space: nowrap; /* CRÍTICO: Impede que o texto quebre linha */
    overflow: hidden;    /* Esconde o texto se não houver espaço */
    text-overflow: ellipsis; /* Adiciona ... se o texto for cortado */
    transition: color 0.3s ease;
    letter-spacing: 0.3px;
}

/* Estado Hover (Passar o mouse) - Não ativo */
...
.sidebar-nav a.active {
    background: linear-gradient(90deg, rgba(255, 215, 0, 0.15) 0%, rgba(255, 215, 0, 0.01) 100%) !important;
    border-left-color: var(--accent-gold) !important;
    color: var(--accent-gold) !important;
    font-weight: normal; /* Mantém peso normal para não mudar largura */
