    ...
    <section class="glass-section fade-item login-highlight">
        <div class="login-content">
            ...
            <p class="free-account-info">
                Com uma conta gratuita, você terá</p><p>acesso aos nossos glossários em pdf.
            </p>
        </div>
    </section>
    <?php endif; ?>
...
body {
    ...
    background-color: #ae8fba !important; /* Tom de roxo claro. Você pode alterar o código HEX para o tom exato que preferir */
}
